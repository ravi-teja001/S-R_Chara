-- Biochar API - Railway PostgreSQL schema
-- Run this in Railway Postgres (or any PostgreSQL) after creating the database.

CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- App users (replaces Supabase auth.users for API auth)
...
-- Expenses (expense_date, expense_amount, expense_type, payment_mode, incharge_id)
